...
public class EndVillagerEntity extends NhModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(0.6f, 1.95f)).build("end_villager").setRegistryName("end_villager");
	public EndVillagerEntity(NhModElements instance) {
		super(instance, 38);
		FMLJavaModLoadingContext.get().getModEventBus().register(new EndVillagerRenderer.ModelRegisterHandler());
	...
	public static class CustomEntity extends VillagerEntity {
		...
		protected void registerGoals() {
			...
			this.goalSelector.addGoal(3, new AvoidEntityGoal(this, EndermiteEntity.class, (float) 6, 1, 1.2));
