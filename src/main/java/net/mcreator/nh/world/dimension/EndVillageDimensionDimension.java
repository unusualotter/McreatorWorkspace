...
package net.mcreator.nh.world.dimension;
...
import net.mcreator.nh.item.EndVillageDimensionItem;
...
public class EndVillageDimensionDimension extends NhModElements.ModElement {
	@ObjectHolder("nh:end_village_dimension_portal")
	public static final CustomPortalBlock portal = null;
	public EndVillageDimensionDimension(NhModElements instance) {
		super(instance, 37);
	...
	public void clientLoad(FMLClientSetupEvent event) {
		...
		DeferredWorkQueue.runLater(() -> {
			try {
				...
				effectsRegistry.put(new ResourceLocation("nh:end_village_dimension"), customEffect);
			} catch (Exception e) {
				e.printStackTrace();
			}
		});
	...
	public static final TicketType<BlockPos> CUSTOM_PORTAL = TicketType.create("end_village_dimension_portal", Vector3i::compareTo, 300);
	public static class POIRegisterHandler {
		...
		public void registerPointOfInterest(RegistryEvent.Register<PointOfInterestType> event) {
			poi = new PointOfInterestType("end_village_dimension_portal",
					Sets.newHashSet(ImmutableSet.copyOf(portal.getStateContainer().getValidStates())), 0, 1)
							.setRegistryName("end_village_dimension_portal");
	...
	public void initElements() {
		...
		elements.items.add(() -> new EndVillageDimensionItem().setRegistryName("end_village_dimension"));
	}
			...
			if (!entity.isPassenger() && !entity.isBeingRidden() && entity.isNonBoss() && !entity.world.isRemote && true) {
				if (entity.func_242280_ah()) {
					entity.func_242279_ag();
						...
						new ResourceLocation("nh:end_village_dimension"))) {
					entity.func_242279_ag();
					teleportToDimension(entity, pos,
							RegistryKey.getOrCreateKey(Registry.WORLD_KEY, new ResourceLocation("nh:end_village_dimension")));
				} else {
					entity.func_242279_ag();
