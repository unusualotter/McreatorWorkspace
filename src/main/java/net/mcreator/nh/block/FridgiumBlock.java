...
public class FridgiumBlock extends NhModElements.ModElement {
	@ObjectHolder("nh:fridgium")
	public static final FlowingFluidBlock block = null;
	@ObjectHolder("nh:fridgium_bucket")
	public static final Item bucket = null;
	public static FlowingFluid flowing = null;
	public static FlowingFluid still = null;
	private ForgeFlowingFluid.Properties fluidproperties = null;
	public FridgiumBlock(NhModElements instance) {
		super(instance, 36);
	...
	public void initElements() {
		...
		}.setRegistryName("fridgium"));
		elements.items.add(() -> new BucketItem(still, new Item.Properties().containerItem(Items.BUCKET).maxStackSize(1).group(ItemGroup.MISC))
				.setRegistryName("fridgium_bucket"));
	}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("fridgium_lakes"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("nh:fridgium_lakes"), configuredFeature);
		}
	}
	@SubscribeEvent
