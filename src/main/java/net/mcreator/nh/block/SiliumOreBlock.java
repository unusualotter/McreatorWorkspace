...
public class SiliumOreBlock extends NhModElements.ModElement {
	@ObjectHolder("nh:silium_ore")
	public static final Block block = null;
	public SiliumOreBlock(NhModElements instance) {
		super(instance, 33);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("nh:silium_ore_match"), () -> CustomRuleTest.codec);
