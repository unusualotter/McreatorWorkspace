...
public class LeadArmorItem extends NhModElements.ModElement {
	@ObjectHolder("nh:lead_armor_helmet")
	public static final Item helmet = null;
	@ObjectHolder("nh:lead_armor_chestplate")
	public static final Item body = null;
	@ObjectHolder("nh:lead_armor_leggings")
	public static final Item legs = null;
	@ObjectHolder("nh:lead_armor_boots")
	public static final Item boots = null;
	public LeadArmorItem(NhModElements instance) {
		super(instance, 56);
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.HEAD, new Item.Properties().group(ItemGroup.COMBAT)) {
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "nh:textures/models/armor/lead_layer_" + (slot == EquipmentSlotType.LEGS ? "2" : "1") + ".png";
			}
