...
public class SiliumAxeItem extends NhModElements.ModElement {
	@ObjectHolder("nh:silium_axe")
	public static final Item block = null;
	public SiliumAxeItem(NhModElements instance) {
		super(instance, 3);
	}
