...
public class SiliumSwordItem extends NhModElements.ModElement {
	@ObjectHolder("nh:silium_sword")
	public static final Item block = null;
	public SiliumSwordItem(NhModElements instance) {
		super(instance, 4);
	}
